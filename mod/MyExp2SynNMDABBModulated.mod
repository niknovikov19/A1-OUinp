...
NEURON {
:  THREADSAFE
  POINT_PROCESS MyExp2SynNMDABBModulated
  RANGE e, i, iNMDA, s, sNMDA, r, tau1NMDA, tau2NMDA, Vwt, smax, sNMDAmax, g, use_pmod, pmod0, m
  POINTER pmod : pointer to a modulation signal
...
PARAMETER {
  ...
  use_pmod = 0 : use dynamic modulation
  pmod0 = 1.0
}
...
ASSIGNED {
  ...
  cao     (mM)
  g       (umho)
  pmod : pointer to a modulation signal
  m
}
