...
from batch_params import AMP_VALUES, F_VALUES, N_SEEDS
...
def _save_lfp_xr(sim, dirpath_res_sub, postfix):
    ...
    lfp_xr.attrs['amp'] = float(cfg.amp)
...
def _get_job_postfix(cfg, exp_name):
    ...
    return f'{exp_id}_seed_{cfg.seed_main}_f_{cfg.f:g}_amp_{cfg.amp:g}'
