...
def apply_exp_cfg(cfg):
    ...
    # Tunable controller params for Optuna
    cfg.ctrl_mu_gain = CTRL_PARAMS['mu_gain']
    cfg.ctrl_ks_ctrl = CTRL_PARAMS['ks_ctrl']
    cfg.ctrl_ku_ctrl = CTRL_PARAMS['ku_ctrl']
    ...
    if CTRL_ON:
        ...
        # Controller params
        cfg.ou_ctrl_params = dict(CTRL_PARAMS)
