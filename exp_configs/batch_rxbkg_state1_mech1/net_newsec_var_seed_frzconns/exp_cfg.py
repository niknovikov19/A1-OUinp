...
def apply_exp_cfg(cfg):
    """Apply experiment settings before batch parameter updates. """
    ...
    cfg.frz_conn_group = None   # batch param
    ...
    cfg.subnet_params = {
        ...
        'conns_frozen': [],   # set in batch_params.py
...
def post_run(sim):
    ...
    postfix = (
        f'{exp_id}_seed_{cfg.seed_main}_frz_{cfg.frz_conn_group}'
    )
